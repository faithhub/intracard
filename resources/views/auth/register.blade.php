...
<head>
    ...
    display: none !important; /* Ensure it overrides other rules */
        ...
        .flex {
    display: flex !important; /* Ensure it overrides other rules */
}
    </style>
</head>
<!--end::Head-->
...
<body id="kt_body" class="app-blank">
    ...
    <div class="position-fixed top-0 end-0 p-3 z-index-3" style="z-index: 2050;">
                        ...
                        <div class="w-lg-800px w-xl-800px p-10 p-lg-15 mx-auto pt-15">
                            ...
                            <form class="my-auto pb-5" novalidate="novalidate" id="kt_create_account_form">
                                ...
                                <div id="rentStep5" class="Rent_mortgage_divs wizardForm substep RentDivTagStep">
                                    ...
                                    <!-- Add this after the "Add Co-Applicant" title -->
                                    <div class="percentage-summary mb-4 p-3 bg-light rounded">
                                        <h5 class="fw-bold mb-3">Percentage Distribution Summary</h5>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <p class="mb-2">Primary Applicant: <span
                                                        id="primaryApplicantPercentage">0</span>%</p>
                                                <p class="mb-2">Co-applicants Total: <span
                                                        id="coApplicantsPercentage">0</span>%</p>
                                            </div>
                                            <div class="col-md-6">
                                                <p class="mb-2">Total Allocated: <span
                                                        id="totalApplicantPercentage">0</span>%</p>
                                                <p class="mb-2">Remaining: <span
                                                        id="remainingApplicantPercentage">100</span>%</p>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            class="form-control mb-2 mb-md-0" placeholder="20%"
                                                            required>
                                                        <span class="error-message"
                                ...
                                <div id="MortgageStep4"
                                    ...
                                    <!-- Add this after the "Add Co-owner" title -->
                                    <div class="percentage-summary mb-4 p-3 bg-light rounded">
                                        <h5 class="fw-bold mb-3">Percentage Distribution Summary</h5>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <p class="mb-2">Primary Owner: <span
                                                        id="primaryOwnerPercentage">0</span>%</p>
                                                <p class="mb-2">Co-owners Total: <span
                                                        id="coOwnersPercentage">0</span>%</p>
                                            </div>
                                            <div class="col-md-6">
                                                <p class="mb-2">Total Allocated: <span
                                                        id="totalPercentage">0</span>%</p>
                                                <p class="mb-2">Remaining: <span
                                                        id="remainingPercentage">100</span>%</p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div id="landlordDetails1" class="landlordDetails1_divs wizardForm">
                                    ...
                                    <div class="mb-10" id="rentFinance">
                                        ...
                                        <label class="d-flex flex-stack mb-5 cursor-pointer">
                                            ...
                                            <span class="form-check form-check-custom form-check-solid">
                                                <input class="form-check-input" type="radio"
                                                    name="landlord_account_mode" value="rentInterac"
                                        ...
                                        <label class="d-flex flex-stack mb-5 cursor-pointer">
                                            ...
                                            <span class="form-check form-check-custom form-check-solid">
                                                <input class="form-check-input" type="radio" required
                                                    name="landlord_account_mode" value="rentCheque"
                                    ...
                                    <div class="w-100">
                                        ...
                                        <div class="pb-1 pb-lg-5">
                                            ...
                                            <div id="validationMessage"
                                                ...
                                                style="display: none !important; margin-bottom: 1rem; border: 1px solid #d93025; background-color: #f8d7da; color: #d93025; padding: 1rem; border-radius: 0.375rem;">
                                                <div>
                                                    <strong>Error:</strong> <span id="validationMessageText"></span>
                                                </div>
                                                <button type="button" class="btn-close" aria-label="Close"
                                                    onclick="closeValidationMessage()"
                                                    style="background: none; border: none; color: #d93025; font-size: 1.25rem; line-height: 1;">
                                                    &times;
                                                </button>
                                            </div>
