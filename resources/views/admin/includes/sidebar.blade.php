...
<div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar"
    ...
    <div class="app-sidebar-logo d-flex justify-content-center align-items-center px-8 py-4" id="kt_app_sidebar_logo">
        <a href="">
            <img alt="Logo" src="{{ asset('assets/images/logos/Intracard.svg') }}"
        ...
        <div class="menu menu-column menu-rounded menu-sub-indention fw-semibold px-3" id="#kt_sidebar_menu"
            ...
            <div class="menu-item">
                @if (Auth::guard('admin')->check())
                    ...
                    <div
                        class="menu-sub menu-sub-accordion px-4 {{ Request::is('admin/equifax-report') || Request::is('admin/transunion-report') ? 'show' : '' }}">
                        <div class="menu-item">
                    ...
                    <a class="menu-link menu-link-sidebar {{ Request::is('admin/users') || Request::is('admin/user/*') ? 'active' : '' }}"
                    ...
                    <!-- Continue with other menu items using the same enhanced styling -->
                @endif
            </div>
        </div>
    </div>
