                        ...
                        <div class="w-lg-800px w-xl-800px p-10 p-lg-15 mx-auto pt-15">
                            ...
                            <form class="my-auto pb-5" novalidate="novalidate" id="kt_create_account_form">
                                ...
                                <div id="RentStep3" class="Rent_mortgage_divs wizardForm substep RentDivTagStep">
                                    ...
                                    <div class="fv-row mb-10">
                                        <!--begin::Label-->
                                        <label class="form-label fw-bold text-gray-900 required">Credit Card limit</label>
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                    ...
                                    <div class="mb-10">
                                        ...
                                        <label class="d-flex flex-stack mb-5 cursor-pointer">
                                            ...
                                            <span class="d-flex align-items-center me-2">
                                                ...
                                                <!--begin::Description-->
                                                <span class="d-flex flex-column">
                                                    <span class="fw-bold text-gray-800 text-hover-primary fs-5">Pay mortgage</span>
                                                    <span class="fs-6 fw-semibold text-muted">I just want to pay my mortgage with a credit or debit card.</span>
                                                </span>
                                                <!--end:Description-->
                                            </span>
                                            <!--end:Label-->
                                ...
                                <div id="landlordDetails6" class="landlordDetails1_divs wizardForm">
                                    ...
                                    <div class="mb-10" id="mortgageFinance">
                                        ...
                                        <div id="EFTInputdiv" style="display: none; margin: 2rem;">
                                                ...
                                                <div class="mb-5 fv-row">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            ...
                                                            <input type="text"
                                                                class="form-control form-control-lg form-control-solid"
                                                                name="mortgage_eft_lender_name" placeholder="" value=""
                                                                data-required>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <label
                                            ...
                                            <fieldset>
                                                ...
                                                <div class="mb-5 fv-row">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <label
                                                                class="form-label fw-bold text-gray-900 mb-3">Institution Number:</label>
                                                            <input type="number"
                                                                class="form-control form-control-lg form-control-solid"
                                                                name="mortgage_eft_institution_number" placeholder="" value=""
                                                                data-required>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <label
                                                                class="form-label fw-bold text-gray-900 mb-3">Transit Number:</label>
                                                            <input type="number"
                                                                class="form-control form-control-lg form-control-solid"
                                                ...
                                                <div class="mb-5 fv-row">
                                                    <label
                                                        class="form-label fw-bold text-gray-900 mb-3">Bank Account Number:</label>
                                                    <input type="number"
                                                        class="form-control form-control-lg form-control-solid"
                                            ...
                                            <fieldset>
                                                <legend>Payment Frequency</legend><div class="mb-5 fv-row">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <label class="form-label fw-bold text-gray-900 mb-3">Select payment frequency:</label>
                                                            <select name="mortgage_eft_payment_frequency"
                                                                class="form-select form-select-solid" id="paymentFrequencySelect">
                                                                <option value="Monthly">Monthly</option>
                                                                <option value="Bi-weekly">Bi-weekly</option>
                                                            </select>
                                                        </div>
                                                        <div class="col-md-6" id="biWeeklyDueDateDiv" style="display: none;">
                                                            <label class="form-label fw-bold text-gray-900 mb-3">Next due date:</label>
                                                            <input type="date"
                                                                class="form-control form-control-lg form-control-solid"
                                                                name="mortgage_eft_bi_weekly_due_date" id="biWeeklyDueDateInput" placeholder="" value="">
                                                        </div>
                                                    </div>
                                                </div>                                                
                                            </fieldset>
                                            <div class="mb-10 fv-row">
                                                <label
                                                    class="form-label fw-bold text-gray-900 mb-3">Reference Number or Code:</label>
                                                <input type="number"
                                                    class="form-control form-control-lg form-control-solid"
                                                    name="mortgage_eft_ref_number" placeholder=""
                                                    value="" data-required>
                                            </div>
                                        </div>
                                        <!--end::Option-->
